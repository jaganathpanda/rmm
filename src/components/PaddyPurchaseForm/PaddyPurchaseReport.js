                    ...
                    <div className="paddy-card-list">
                        {filteredData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => (
                            <div className="paddy-card" key={index}>
                                ...
                                <h4>👨‍🌾 {row[4]}</h4>
                                <p><strong>Serial No:</strong> {row[3]}</p>
                                <p><strong>Purchase Date:</strong> {row[8]}</p>
                                <p><strong>Total Paddy:</strong> {row[10]} KG</p>
                                <p><strong>Price per Bag:</strong> ₹{row[11]}</p>
                                <p><strong>Paddy Type:</strong> {row[15]}</p>
                                <p><strong>Collection Center:</strong> {row[16]}</p>
                            </div>
                        ))}
                    </div>
